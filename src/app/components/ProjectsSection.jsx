...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects">
      <h2 className="mt-4 mb-3 text-4xl font-bold text-center text-white md:mb-12">
        My Projects
      </h2>
      <div className="flex flex-row flex-wrap items-center justify-center gap-2 py-5 mb-3 text-white">
        <ProjectTag
